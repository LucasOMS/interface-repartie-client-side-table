...
import { GAME_BACKGROUND_IMG_NO_TRANSPARENT, JOURNAL_END_IMG } from '../utils/constants';
...
export class EndBuilder extends Builder {
  ...
  draw() {
    ...
    this._newspaper = new ImageElementWidget(500, 60, 940, 880, 0, 1, JOURNAL_END_IMG);
